...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    units: [
      lin('bit', 'Биты', 1),
      lin('b', 'Байты', 8),
      // Десятичные (SI): 1 КБ = 1000 байт
      lin('kb', 'Килобайты (КБ)', 8 * 1000),
      lin('mb', 'Мегабайты (МБ)', 8 * 1000 ** 2),
      lin('gb', 'Гигабайты (ГБ)', 8 * 1000 ** 3),
      lin('tb', 'Терабайты (ТБ)', 8 * 1000 ** 4),
      // Двоичные (IEC): 1 КиБ = 1024 байта
      lin('kib', 'Кибибайты (КиБ)', 8 * 1024),
      lin('mib', 'Мебибайты (МиБ)', 8 * 1024 ** 2),
      lin('gib', 'Гибибайты (ГиБ)', 8 * 1024 ** 3),
      lin('tib', 'Тебибайты (ТиБ)', 8 * 1024 ** 4),
    ],
  },
  {
